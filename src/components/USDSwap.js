...
export default function USDSwap() {
  return (
    <>
            ...
            <h4 className='left-right-head'>Swap</h4>
              <div class="swaps" role="tabpanel">
                  <ul class="swap-tabs" role="tablist">
                      <li role="presentation"><a href="#USDSwap" aria-controls="home" role="tab" data-toggle="tab">Swap</a></li>
                      <li role="presentation" class="active"><a href="#USDBuy" aria-controls="profile" role="tab" data-toggle="tab">Buy Crypto</a></li>
                  </ul>
                  <div class="tab-content tabs">
                      <div role="tabpanel" class="tab-pane fade" id="USDSwap">
                      ...
                      <div role="tabpanel" class="tab-pane fade in active" id="USDBuy">
                        <BitCoin/>
                      </div>
                  </div>
              </div>
