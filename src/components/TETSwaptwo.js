...
export default function TETSwaptow() {
  return (
    <>
       ...
       <div className="swap_box">
            ...
            <div class="swaps" role="tabpanel">
                  <ul class="swap-tabs" role="tablist">
                      <li role="presentation"><a href="#mTETSwap" aria-controls="home" role="tab" data-toggle="tab">Swap</a></li>
                      <li role="presentation" class="active"><a href="#mTETBuy" aria-controls="profile" role="tab" data-toggle="tab">Buy Crypto</a></li>
                  </ul>
                  <div class="tab-content tabs">
                      <div role="tabpanel" class="tab-pane fade" id="mTETSwap">
                      ...
                      <div role="tabpanel" class="tab-pane fade in active" id="mTETBuy">
                        <BitCoin/>
                      </div>
                  </div>
            </div>
