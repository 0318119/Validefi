       ...
       <div className="swap_box">
            ...
            <div class="swaps" role="tabpanel">
                  <ul class="swap-tabs" role="tablist">
                      <li role="presentation"><a href="#mETHSwap" aria-controls="home" role="tab" data-toggle="tab">Swap</a></li>
                      <li role="presentation" class="active"><a href="#mETHBuy" aria-controls="profile" role="tab" data-toggle="tab">Buy Crypto</a></li>
                  </ul>
                  <div class="tab-content tabs">
                      <div role="tabpanel" class="tab-pane fade" id="mETHSwap">
                      ...
                      <div role="tabpanel" class="tab-pane fade in active" id="mETHBuy">
                        <BitCoin/>
                      </div>
                  </div>
            </div>
