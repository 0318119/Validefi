        ...
        {console.log("post",resd)}      
            ...
            <table>
                ...
                <tbody>         
                    ...
                    return(
                        <tr key={key}>
                            <td className='date_table'>{(post.block.timestamp.iso8601).replace('T','..').slice(0, -2)}</td>
                            ...
                            <td className='truncate'>{(post.baseAmount).replace('00000','..')}</td>
                            <td className='truncate maker_table'>{(post.maker.address)}</td>
                        </tr>
