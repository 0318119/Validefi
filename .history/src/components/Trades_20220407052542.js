                ...
                <tbody>         
                    ...
                    return(
                        <tr key={key}>
                            ...
                            <td className='green'>{(post.baseAmount).slice(0, -5)}</td>                  
                            <td className=''>{(post.quoteAmount).slice(0, -5)}</td>
                            <td className=''>{(post.quotePrice).slice(0, -5)}</td>
                            <td className=''>{(post.baseAmount).slice(0, -5)}</td>
                            <td className=' maker_table'>{(post.maker.address).slice(0, -5)}</td>
                        </tr>
